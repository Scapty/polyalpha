...
function generateFallbackReport(reportType, tone, markets) {
  ...
  return `## PolyAlpha ${reportType}
### ${date}

> ⚠️ **Demo Report** — Generated without AI. Set your Anthropic API key for AI-powered reports with web search.
...
This demo report was generated by PolyAlpha using real-time market data from the Polymarket Gamma API. For full AI-powered analysis with web search, configure your Anthropic API key.
